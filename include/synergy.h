...
int pmd_unmap(/*char *, int, unsigned short*/) ;
int pmd_map(/*char *, unsigned short, unsigned short*/) ;
int pmd_getmap(/*char *, unsigned long, unsigned short*/) ;
int ping_pmd(/*unsigned long*/) ;
...
int start_dac(/*unsigned short *, char **/) ;
int start_app(/*unsigned short*/) ;
int save_process_status(/*unsigned short, char **/) ;
int save_all_status(/*unsigned short*/) ;
int verify_app(/*unsigned short, char **/) ;
int get_process_status(/*unsigned short, char *, unsigned short *, u_char **/) ;
int get_process_state(/*unsigned short, char *, unsigned short **/) ;
int get_app_state(/*unsigned short, unsigned short **/) ;
int kill_process(/*unsigned short, char **/) ;
int exit_app(/*unsigned short*/) ;
int exit_dac(/*unsigned short*/) ;
